    ...
    const handleChange = (e) => {
        ...
        if (name === "image") {
            ...
            setState({
                ...state,
                image: file,
                previewImage: URL.createObjectURL(file) // create preview URL
            });
        } else {
            setState({
                ...state,
                    ...
                    <div className=" mt-4 flex gap-6">
                        <div className="w-7/12 gap-4">
                            ...
                            <div className="mt-2">
                                ...
                                <textarea id="description" type="text" className="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring" name="description"
                            ...
                            <div className="mt-2">
                                ...
                                {state.previewImage || state.image ? <img src={state.previewImage ? state.previewImage : state.image } alt="Preview" className="h-32 mt-2 w-auto mx-auto" />
                                : ''}
