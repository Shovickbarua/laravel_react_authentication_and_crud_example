    ...
    <div>
        {message && 
          ...
          <div className="flex justify-between ">
                ...
                <div>
                    <Link to='/' className="mr-2 bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow mb-4">
                        Inventory                    
                    </Link>
                    <Link to='/add-item' className="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow mb-4">
                        Add
                    </Link>
                </div>
            </div>
                                  ...
                                  {state.map((item, index) => (
                                      <tr className="hover:bg-gray-100 dark:hover:bg-gray-700" key={index}>
                                          ...
                                          <td className="py-8 px-6 text-sm font-medium float-right whitespace-nowrap flex my-auto">
                                              <Link to={'/edit-item/' + item.id}  className="text-blue-600 dark:text-blue-500 hover:underline text-2xl"><FaEdit/></Link>
